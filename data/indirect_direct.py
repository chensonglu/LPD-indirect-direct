...
INDIRECT_DIRECT_CLASSES = (  # always index 0
    'car', 'carplate')


class INDIRECT_DIRECTAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(INDIRECT_DIRECT_CLASSES, range(len(INDIRECT_DIRECT_CLASSES))))
...
class INDIRECT_DIRECTDetection(data.Dataset):
    ...
    def __init__(self, root,
                 image_sets=None,
                 transform=None, target_transform=INDIRECT_DIRECTAnnotationTransform(keep_difficult=True),
